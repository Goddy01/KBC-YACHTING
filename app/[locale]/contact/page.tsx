      ...
      <section className="bg-cream py-16 md:py-24">
        <Container>
          <div className="grid gap-16 lg:grid-cols-12">
            ...
            <SectionReveal className="lg:col-span-5 lg:col-start-8" delay={0.1}>
              <div>
                ...
                <p className="mt-2 text-navy/55">{t("officeCity")}</p>
              </div>

              <div className="relative mt-10 aspect-[4/3] overflow-hidden bg-navy/10">
                <Image
                ...
                <div className="absolute inset-0 flex items-end bg-gradient-to-t from-navy/70 to-transparent p-6">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-cream/80">
                    {t("mapLabel")}
                  </p>
                </div>
              </div>
